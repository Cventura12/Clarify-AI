        ...
        <div className="flex min-h-screen flex-col lg:flex-row">
          ...
          <main className="relative flex-1 overflow-hidden bg-[var(--app-main-bg)]">
            <div className="pointer-events-none absolute inset-0">
              <div className="absolute -top-24 right-[-8rem] h-80 w-80 rounded-full bg-[var(--accent)]/20 blur-[140px]" />
              <div className="absolute bottom-[-12rem] left-[-10rem] h-96 w-96 rounded-full bg-[var(--accent-2)]/18 blur-[160px]" />
